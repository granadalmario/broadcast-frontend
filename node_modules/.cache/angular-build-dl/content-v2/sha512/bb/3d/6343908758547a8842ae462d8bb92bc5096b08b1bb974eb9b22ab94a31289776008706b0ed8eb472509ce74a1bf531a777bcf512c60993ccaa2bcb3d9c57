...
/*!**********************************!*\
  !*** ./src/app/_models/index.ts ***!
  \**********************************/
/*! exports provided: Alert, AlertType, User, Empleado */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _empleado__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./empleado */ "./src/app/_models/empleado.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Empleado", function() { return _empleado__WEBPACK_IMPORTED_MODULE_2__["Empleado"]; });
...
class AccountService {
    constructor(router, http) {
        ...
        this.empleadoSubject = new rxjs__WEBPACK_IMPORTED_MODULE_1__["BehaviorSubject"](JSON.parse(localStorage.getItem('empleado')));
    ...
    registerEmpleado(empleado) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado/register`, empleado);
    }
    getAll() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users`);
    }
    getAllEmpleados() {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado`);
    }
    getById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/users/${id}`);
    }
    getEmpleadoById(id) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado/${id}`);
    }
    getEmpleadosByName(name) {
        return this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado/name/${name}`);
    }
    update(id, params) {
    ...
    updateEmpleado(id, params) {
        return this.http.put(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado/${id}`, params);
    }
    delete(id) {
    ...
    deleteEmpleado(id) {
        return this.http.delete(`${_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiUrl}/empleado/${id}`);
    }
}
...
const playModule = () => __webpack_require__.e(/*! import() | play-play-module */ "play-play-module").then(__webpack_require__.bind(null, /*! ./play/play.module */ "./src/app/play/play.module.ts")).then(x => x.PlayModule);
const routes = [
    ...
    { path: 'play', loadChildren: playModule, canActivate: [_helpers__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app"]], decls: 11, vars: 4, consts: [["class", "navbar navbar-expand navbar-dark bg-dark", 4, "ngIf"], [1, "app-container", 3, "ngClass"], [1, "text-center", "mt-4"], ["href", "https://jasonwatmore.com/post/2020/04/28/angular-9-user-registration-and-login-example-tutorial", "target", "_top"], ["href", "https://jasonwatmore.com", "target", "_top"], [1, "navbar", "navbar-expand", "navbar-dark", "bg-dark"], [1, "navbar-nav"], ["routerLink", "/", "routerLinkActive", "active", 1, "nav-item", "nav-link", 3, "routerLinkActiveOptions"], [1, "nav-item", "nav-link", 3, "click"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
HomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HomeComponent, selectors: [["ng-component"]], decls: 8, vars: 1, consts: [[1, "p-4"], [1, "container"], ["href", "\\play"], ["src", "./assets/images/UKFlag.png", "width", "100px", "height", "100px", "alt", ""]], template: function HomeComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! /home/alberto/Modeling/frontend-modeling/src/main.ts */"./src/main.ts");
